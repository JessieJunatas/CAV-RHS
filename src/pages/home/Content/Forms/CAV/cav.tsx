...
function CAV() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // ↓ Pass preparedOptions and submittedOptions so names can be resolved without extra DB calls
  ...
  const handleDownload = async () => {
    if (!savedForm) return
    // generateCavPDF fetches signatories itself via Supabase — no changes needed here
